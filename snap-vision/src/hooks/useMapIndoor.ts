...
export const useMapIndoor = (): UseMapIndoorReturn => {
  ...
  const getRoomDegrees = useCallback(async (locationId: string, buildingId: string, floorId?: string) => {
    let q: any = firestore()
  ...
  const areRoomsConnected = useCallback(async (
    locationId: string,
    buildingId: string,
    startRoomId: string,
    endRoomId: string,
  ...
  const openIndoorNavigation = useCallback(async (
    building: POI,
    setErrorPopupMessage: (message: string) => void,
    setShowErrorPopup: (show: boolean) => void
  ) => {
  ...
  const startIndoorNavigation = useCallback(async (
    navigation: any,
    setErrorPopupMessage: (message: string) => void,
    setShowErrorPopup: (show: boolean) => void
  ) => {
